...
IF ERRORLEVEL 1 (
    echo Configurando email de usuario Git...
...
IF ERRORLEVEL 1 (
    ...
    git remote add origin https://github.com/nicolasfp/dashboard-fondos-mutuo.git
) ELSE (
    echo Remote origin ya existe, actualizando URL...
    git remote set-url origin https://github.com/nicolasfp/dashboard-fondos-mutuo.git
)
